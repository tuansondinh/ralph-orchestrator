# Ralph Hat Collections (Embedded Presets)

This directory contains the embedded hat collection YAML files included in the `ralph` binary.

Canonical editable preset files live at `presets/*.yml` and are mirrored here for `include_str!` packaging.
